...
<html lang="id">
  ...
  <body class="font-sans bg-gray-50 text-gray-800">
    ...
    <div class="px-10 py-10">
      <h2 class="text-2xl font-bold mb-4">Timeline Pengalaman Kuliah</h2>
    
      <?php 
      $pengalaman = [
      ["tahun" =>"2024", "judul" => "Masuk Kuliah", "deskripsi" => "Memulai kuliah di Universitas Trunojoyo Madura."], ["tahun" => "2024", "judul" => "Bergabung UKMFT-ITC", "deskripsi" => "Aktif mengikuti kegiatan di UKMFT-ITC."], ["tahun" => "2024", "judul" => "Proyek Akhir ALPRO", "deskripsi" => "Membuat aplikasi sederhana sebagai proyek akhir praktikum Algoritma Pemrograman."] ] ; 
